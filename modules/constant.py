...
#GPIO_ROTARY_SW = 15
# BOARD
GPIO_ROTARY_CLK = 16 #-> 16
GPIO_ROTARY_DT = 13 #-> 13
GPIO_ROTARY_SW = 15 #-> 15
...
MENU_WAIT_SECONDS = 20

CORE_PID = "core.pid"
CORE_CONF = "config.conf"
...
MQTT_TOPIC_ANIMATION_START = "Morphee/animation/start"
MQTT_TOPIC_ANIMATION_STOP = "Morphee/animation/stop"
...
HA_URI = "http://192.168.1.236:8123"
HA_AUTH_TOKEN = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiI5YjNiMDgwODY1ZWI0OTk5YjBkZWY4YzMxZGU4Y2Y2MiIsImlhdCI6MTcyMjYxNjUxMywiZXhwIjoyMDM3OTc2NTEzfQ.V88UfzdYBAW3Qd4d3cnct8PgyFQ7cCY6hBrUtS4_zE8"
...
SECTORS = [SECTOR_1, SECTOR_2, SECTOR_3, SECTOR_4, SECTOR_5, SECTOR_6, SECTOR_7]
